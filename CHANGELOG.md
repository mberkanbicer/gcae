...
- Interactive architecture diagram (`docs/architecture.html`) — components, primary path,
  command-sandbox trust boundary and curated views; linked from the documentation table.
