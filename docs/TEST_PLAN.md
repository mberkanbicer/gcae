...
verified speculative changes, merge confirmation, the guarded `gcae merge` command and reversible
merge undo, and a mandatory end-to-end bad-then-good rollback trajectory.
