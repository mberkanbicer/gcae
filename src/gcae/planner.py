...
def build_replan_prompt(
    ...
    return (
        ...
        f"REVALIDATION REQUIRED (already verified once; evidence died with an "
        f"invalidated step — plan a cheap revalidation, not a rebuild): "
        f"{json.dumps(state.revalidation_required)}\n"
